...
python -u -m montlake.exec.run_exp --config /homes/sjkoelle/montlake/experiments/configs/rigidethanol_diagram.json --outdir /homes/sjkoelle/thesis_data/processed_data/rigidethanol --raw_data /homes/sjkoelle/thesis_data/raw_data/rigidethanol_nonoise.npy --nreps 25
python -u -m montlake.exec.run_exp --config /homes/sjkoelle/montlake/experiments/configs/toluene_diagram.json --outdir /homes/sjkoelle/thesis_data/processed_data/toluene --raw_data /homes/sjkoelle/thesis_data/raw_data/toluene.mat --nreps 25
