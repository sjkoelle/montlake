...
__all__ = ['get_detected_values2d', 'get_support_indices2d', 'get_supports_lasso', 'get_supports_brute',
           'get_supports_brute_tslasso', 'Replicate']
...
def get_supports_lasso(replicates, p,d):
    ...
    support_tensor = np.zeros(np.repeat(p,d), dtype = int)
